...
public class JStringUtils {
    ...
    /**
     * Splits the SQL into tokens. Any alphanumeric (including underscore)
     * sequence is considered a token. All other individual special characters
     * are considered their own tokens. White space and SQL comments are not
    ...
    /**
     * Splits and replaces string containing escaped single quotes with CONCAT
     * function, e.g. 'escaped '' string' would be modified as CONCAT('escaped
     * ','\'',' string')
     *
